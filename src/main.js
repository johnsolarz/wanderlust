...
// FS45GKSEWV2LJDOTW25TSGCIEZ0OFOBKONXSKJ0PJEQO3DSQ // PU3IY1PZEOOANTPSHKNMS5HFSMEGEQ1IAVJYGYM4YVZP3NGD
const clientSecret = '0V21IXU0EETE3SZJGGCP4T4R13NUTBJ0LMI5WQY45IMDPEKY';
// MBR4MNUDTO5VFDKSFZIJ5AW3QD14TJKWC2WF14IZTEKPJOZ0 // 0V21IXU0EETE3SZJGGCP4T4R13NUTBJ0LMI5WQY45IMDPEKY
const url = 'https://api.foursquare.com/v2/venues/explore?near=';
const imgPrefix = 'https://igx.4sqi.net/img/general/150x200';

// APIXU Info
const apiKey = 'a43783b78e244802871223110171412';
...
async function getVenues() {
  ...
  const urlToFetch = url + city + '&venuePhotos=1&limit=10&client_id=' + clientId + '&client_secret=' + clientSecret + '&v=20171215';
  try {
...
async function getForecast() {
  const city = $input.val();
  const urlToFetch = forecastUrl + apiKey + '&q=' + city + '&days=4&hour=12';
  try {
    let response = await fetch(urlToFetch);
    if (response.ok) {
      let jsonResponse = await response.json();
